...
export async function getServerSideProps(context){
  ...
  const results = await fetch(
    `https://newsapi.org/v2/top-headlines?country=us&apiKey=d192fda5fa714245807d02d717141cef``https://newsapi.org/v2/everything?q=tesla&from=2022-01-02&sortBy=publishedAt&apiKey=${process.env.NEWS_API_KEY}`
  );
  return{
    props:{
      session,
